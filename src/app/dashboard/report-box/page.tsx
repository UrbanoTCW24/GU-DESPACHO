...
import { getBoxReport } from './actions'
...
export default async function BoxReportPage() {
    ...
    return (
        <div className="space-y-6">
            ...
            <Card>
                <CardHeader>
                    <CardTitle>Listado de Cajas Recientes (Últimas 200)</CardTitle>
                </CardHeader>
                <CardContent>
                                        ...
                                        <TableRow key={box.id}>
                                            ...
                                            <TableCell>
                                                <div className="flex flex-col">
                                                    <span className="font-semibold">{box.models?.brands?.name}</span>
                                                    <span className="text-xs text-muted-foreground">{box.models?.name}</span>
                                                </div>
                                            </TableCell>
                                            ...
                                            <TableCell className="text-sm">{box.users?.email || 'Sistema'}</TableCell>
                                            <TableCell>
